...
//Description: This code creates 20 threads and has them output a statement (with their supposed iteration number and thread ID) to the terminal. All 20 threads get 'returned' (on the terminal) but are not joined together using pthread_join.
#include <stdio.h>
#include <unistd.h>
#include <pthread.h>
